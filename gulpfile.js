...
function rebundle() {
    return bundler.transform(babelify.configure({ plugins: ['object-assign'] }))
      .bundle()
...
gulp.task('activities', function() {
    gulp.src('app/activities/file-picker/**/*').pipe(gulp.dest('dist/activities/file-picker'));
});

// Robots.txt and favicon.ico
gulp.task('extras', function() {
    return gulp.src(['app/*.ico', 'app/*.webapp'])
        .pipe(gulp.dest('dist/'))
        .pipe($.size());
});

// Watch
gulp.task('watch', ['html', 'fonts', 'bundle', 'extras'], function() {
